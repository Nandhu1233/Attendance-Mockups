								...
								<div class="text-center mb-4" id="log_display"></div>
									<form action="" id="att-log-frm" >
										<div class="form-group">
											...
											<input type="text" placeholder="Enter 8 digit access code with hyphens" id="eno" name="eno" class="form-control col-sm-15">
										</div>
										<center>
											<button type="button" class='btn btn-sm btn-primary log_now col-sm-5' data-id="1">IN Morning</button>
											<button type="button" class='btn btn-sm btn-primary log_now col-sm-5' data-id="2">OUT Morning</button>
											<button type="button" class='btn btn-sm btn-tertiary log_now col-sm-5' data-id="3">IN Afternoon</button>
											<button type="button" class='btn btn-sm btn-tertiary log_now col-sm-5' data-id="4">OUT Evening</button>
										</center>
